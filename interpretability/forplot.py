# -*- coding: utf-8 -*-
"""mnist on the line 2d

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/13fr_YABOwCLch6M2cNGuahZOjTsVV2w0
...
plt.legend()
plt.savefig("plots/delta1.png",format="png")
plt.savefig("plots/delta1.pdf",format="pdf")
plt.show()

plt.hist(pn,bins=25,alpha=0.5,label="normal",density=True)
plt.hist(pa,bins=25,alpha=0.5,label="abnorm",density=True)
plt.legend()
plt.savefig("plots/hist.png",format="png")
plt.savefig("plots/hist.pdf",format="pdf")
plt.show()
...
plt.savefig("plots/map.png",format="png")
plt.savefig("plots/map.pdf",format="pdf")
plt.show()
